...
class ExperimentTemplate(Base):
    ...
    version_number: Mapped[int] = mapped_column(sa.Integer, default=1)
    is_current_version: Mapped[bool] = mapped_column(sa.Boolean, default=True)
    parent_template_id: Mapped[Optional[int]] = mapped_column(sa.Integer, sa.ForeignKey("experiment_templates.id"), nullable=True)
    created_at: Mapped[datetime] = mapped_column(sa.DateTime, default=datetime.utcnow)
...
class BatchRun(Base):
    ...
    template_version: Mapped[int] = mapped_column(sa.Integer, default=1)
    status: Mapped[str] = mapped_column(sa.String(50), default="pending")
    max_parallel: Mapped[int] = mapped_column(sa.Integer, default=1)
    ...
    started_at: Mapped[Optional[datetime]] = mapped_column(sa.DateTime, nullable=True, default=None)
    finished_at: Mapped[Optional[datetime]] = mapped_column(sa.DateTime, nullable=True, default=None)
    last_progress_at: Mapped[Optional[datetime]] = mapped_column(sa.DateTime, nullable=True, default=None)
